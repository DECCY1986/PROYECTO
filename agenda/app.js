...
const STORAGE_KEY = 'agenda2026_dimalcco_offline_pro_v1';
...
function exportCSV(allMonths) {
    ...
    a.href = url;
    a.download = allMonths ? 'Agenda_2026_DIMALCCO_TODO.csv' : ('Agenda_2026_' + ((MONTHS.find(x => x.key === state.month) || {}).label || 'Mes') + '.csv');
