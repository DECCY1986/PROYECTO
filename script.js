document.addEventListener('DOMContentLoaded', () => {
    ...
    let transactions = JSON.parse(localStorage.getItem('taxTransactions')) || [
    ...
    const saveToLocalStorage = () => {
        localStorage.setItem('taxTransactions', JSON.stringify(transactions));
    };
    ...
    if (btnPrintDashboard) btnPrintDashboard.onclick = () => window.print();
